...
<head>
    ...
    <script src="${resource(dir: 'plugins/jquery-1.8.3/js/jquery', file: 'jquery-1.8.3.min.js')}"
            type="text/javascript"></script>
    <link href="${resource(dir: 'css', file: 'bootstrap.css')}" type="text/css" media="screen, projection"
          rel="stylesheet"/>
    ...
    <g:form controller="home" action="buscar" name="form" class="span6 offset3">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <g:textField name="tramite" class="tramite-ctrl" autocomplete="off"
                             placeholder="Trámite a realizar"></g:textField>
            </div>
